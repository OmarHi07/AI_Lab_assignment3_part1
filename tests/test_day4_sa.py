...
def run_sa_on_instance(vrp_path: Path, max_iterations: int = 10000):
    print("=" * 80)
    ...
    print("SA best cost:", round(result.best_cost, 2))
    ...
    output_path = output_folder / f"{instance.name}_sa.txt"
    plot_path = plot_folder / f"{instance.name}_sa.png"
...
def main():
    ...
    # Start with small and medium instances.
    # Do not start with M-n200 or X-n101 yet.
    test_files = [
        "P-n16-k8.vrp",
        "E-n22-k4.vrp",
        "A-n32-k5.vrp",
    ...
    print("Day 4: Simulated Annealing test\n")
    ...
    for file_name in test_files:
        ...
        run_sa_on_instance(vrp_path, max_iterations=10000)
