...
def run_tabu_on_instance(vrp_path: Path):
    print("=" * 80)
    ...
    print("Tabu best cost:", round(result.best_cost, 2))
    ...
    print("Tabu skipped moves:", result.tabu_skipped_moves)
    ...
    output_path = output_folder / f"{instance.name}_tabu.txt"
    plot_path = plot_folder / f"{instance.name}_tabu.png"
